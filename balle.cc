...
std::ostream& operator<<(ostream& sortie, Balle const& b) {
	sortie << b.masse() << " # masse" << endl;
	sortie << b.get_rayon() << " # rayon" << endl;
	sortie << b.get_masseVol() << " # masse volumique" << endl;
	sortie << b.get_pos() << " # position" << endl;
	sortie << b.get_vit() << " # vitesse" << endl;
	sortie << b.get_force() << " # force" << endl;
	return sortie;
}
